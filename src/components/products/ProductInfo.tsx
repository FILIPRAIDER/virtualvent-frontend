...
export const ProductInfo = (product: ProductProps) => {
  return (
    <div className="bg-white flex flex-col p-6 gap-4 border border-gray-200 rounded-[8px] shadow-md h-[500px]">
      ...
      <p className="text-2xl font-bold text-[#093F51]">
      ...
      <button className="w-full bg-[#093F51] text-white py-2 rounded-md mt-4">
        Comprar Ahora
      </button>
      <button className="w-full flex items-center justify-center gap-2 bg-teal-600 text-white py-2 rounded-md mt-2">
        <TbShoppingCartPlus />
        Agregar al carrito
      </button>
    </div>
